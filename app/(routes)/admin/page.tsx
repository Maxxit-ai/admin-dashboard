...
// Note: Metadata should be exported from a layout.tsx or page.tsx (non-client component)
// For client components, we handle title via document.title in useEffect if needed
              ...
              {selectedTab === "agents" && (
                <div>
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    {(["subscribers", "pnl", "positions", "name"] as const).map(
                      (sort) => (
                        <button
                          key={sort}
